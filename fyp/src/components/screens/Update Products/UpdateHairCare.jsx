...
const UpdateHairCare = () => {
  ...
  const deleteHairCare = (postid) => {
    fetch(`/deletehaircare/${postid}`, {
      method: "delete",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("jwt"),
      },
  ...
  const updateStock = (postTitle) => {
    ...
    if (!/^-?\d+\.?\d*$/.test(quantity)) {
      ...
      fetch(`/updatehairstock/${postTitle}`, {
        method: "put",
        headers: {
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => deleteHairCare(item._id)}
                      >
