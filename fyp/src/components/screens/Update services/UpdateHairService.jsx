...
const UpdateHairService = () => {
  ...
  const deleteHairService = (postid) => {
    fetch(`/deletehairservice/${postid}`, {
      method: "delete",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("jwt"),
      },
  ...
  const updatePrice = (postTitle) => {
    ...
    if (!/^-?\d+\.?\d*$/.test(price)) {
      ...
      fetch(`/updatehairservicePrice/${postTitle}`, {
        method: "put",
        headers: {
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => deleteHairService(item._id)}
                      >
...
export default UpdateHairService;
