...
const UpdateSkinService = () => {
  ...
  const deleteSkinService = (postid) => {
    fetch(`/deleteskinservice/${postid}`, {
      method: "delete",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("jwt"),
      },
  ...
  const updatePrice = (postTitle) => {
    ...
    if (!/^-?\d+\.?\d*$/.test(price)) {
      ...
      fetch(`/updateskinservicePrice/${postTitle}`, {
        method: "put",
        headers: {
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => deleteSkinService(item._id)}
                      >
...
export default UpdateSkinService;
